...
export default function SignUpGoogleAbout() {
    ...
    const name = useAuthCreate(state => state.name);
    const image = useAuthCreate(state => state.image);
        ...
        <Root page="signup" title="Tell us about yourself">
            ...
            >
                ...
                <div className="wrapper about">
                    <div className="bar">
                        <div className={`line this6`} />
                        <div className="back">
                            <IoIosArrowBack onClick={() => setPage(5)} />
                            <div className="step">
                                <p>Step 2 of 2</p>
